...
<h4>On the web</h4> 
By clicking the corresponding links below, you can visualize any kernel in our dataset. Resulting [views](#ss1) will be identical to  the ones generated by running the viewer `view/showkernel.js` locally. 
